...
```bash
python -u utils/split_isprs_dataset.py --images_dir $HOME/data/Potsdam/2_Ortho_RGB/ --labels_dir $HOME/data/Potsdam/5_Labels_all/ --output_dir $HOME/data/potsdam-rgb-dataset-256-128/ --patch_size 256 --stride 128 --seed 42 --pad
python -u utils/split_isprs_dataset.py --images_dir $HOME/data/Potsdam/3_Ortho_IRRG/ --labels_dir $HOME/data/Potsdam/5_Labels_all/ --output_dir $HOME/data/potsdam-irrg-dataset-256-128/ --patch_size 256 --stride 128 --seed 42 --pad
python -u utils/split_isprs_dataset.py --images_dir $HOME/data/Vaihingen/ISPRS_semantic_labeling_Vaihingen/top/ --labels_dir $HOME/data/Vaihingen/ISPRS_semantic_labeling_Vaihingen_ground_truth_COMPLETE/ --output_dir $HOME/data/vaihingen-irrg-dataset-256-128/ --patch_size 256 --stride 128 --seed 42 --pad
```
...
```bash
python -u train.py --data_dir $HOME/data/flair-dataset/ --results_dir ./results/flair/ --epochs 50 --batch_size 8 --learning_rate 0.0001 0.0001 --model deeplabv3 --dataset flair --comment "Train DeepLabV3 segmentation model with ResNet-50 backbone on FLAIR RGB images of size 512x512"
python -u test.py --data_dir $HOME/data/flair-dataset/ --output_dir ./submits/ --ckpt_path ./results/flair/deeplabv3-240929-082119/checkpoints/epoch=23-step=38520.ckpt --dataset flair --model deeplabv3 --enable_progress_bar --test_only
```
...
python -u test.py --data_dir $HOME/data/flair-dataset/ --output_dir ./submits/ --model colormapgan --dataset unpaired-flair --ckpt_path ./results/flair/colormapgan-240929-041910/checkpoints/epoch=9-step=10040.ckpt --enable_progress_bar --predict_only
```

```bash
python -u train.py --data_dir ./submits/colormapgan-240929-041910/ --results_dir ./results/flair/ --epochs 50 --batch_size 8 --learning_rate 0.00002 0.00002 --model deeplabv3 --dataset isprs --ckpt_path ./results/flair/deeplabv3-240929-082119/checkpoints/epoch=23-step=38520.ckpt --comment "Finetune DeepLabV3 segmentation model with ResNet-50 backbone on FLAIR RGB images of size 512x512 adapted using ColorMapGAN"
```
